...
class SpecsListView extends StatefulWidget {
  SpecsListView();

  @override
  _SpecsListViewState createState() => _SpecsListViewState();
}

class _SpecsListViewState extends State<SpecsListView>
    with SingleTickerProviderStateMixin {
  @override
  void didUpdateWidget(SpecsListView oldWidget) {
                ...
                : Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            child: PagedSpecsListView(
                              {
                                if (model.q!.isNotEmpty) 'q': model.q!,
                                if (model.selected_spec != null)
                                  'filters':
                                      'specialization:[${model.selected_spec!.id}]'
                              },
                              onSpecsClicked: (move) {},
                            ),
                          ),
